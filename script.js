...
var specialCharacters = [
  ...
  function getPasswordOptions() {
    ...
    if(isNaN(length) === true){
      alert('Must be provided as number');
      return;
    }
    if(length < 10) {
    ...
    if(length > 64) {
      alert ('Must be less than 65 characters');
      return;
    }
    let hasSpecialCharacters = confirm(
      "Click OK if you'd like to include special characters"
    )
    let hasNumericCharacters = confirm(
      "Click OK if you'd like to include numeric characters"
    )
